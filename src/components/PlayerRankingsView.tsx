...
import {
  ...
  type PlayerFilters,
  type CompFilters,
  type CompetitionRankRow,
} from "@/lib/fm-player-rankings";
...
export function PlayerRankingsView({
  mode,
  withDecay,
}: {
  mode: "weighted" | "raw";
  ...
  const filtered = useMemo(() => {
    const f: PlayerFilters = {
      ...filters,
      comp_type: compFilter === "unified" ? "all" : compFilter,
    };
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
          <div>
            ...
            <Input
              ...
              placeholder="jogador/clube/competição/país"
            />
          </div>
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                setFilters({ ...filters, yearFrom: v === "all" ? null : Number(v) });
                setPage(0);
              }}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                setFilters({ ...filters, yearTo: v === "all" ? null : Number(v) });
                setPage(0);
              }}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                setFilters({ ...filters, continent: v === "all" ? "" : v });
                setPage(0);
              }}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                setFilters({ ...filters, country: v === "all" ? "" : v });
                setPage(0);
              }}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                setFilters({ ...filters, club: v === "all" ? "" : v });
                setPage(0);
              }}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                setFilters({ ...filters, competition: v === "all" ? "" : v });
                setPage(0);
              }}
            >
              <SelectTrigger>
          ...
          <TabsContent key={t.key} value={t.key}>
            <Card className="overflow-hidden">
                    ...
                    {pageRows.map((r, i) => (
                      <tr key={r.key} className="border-t border-border/50 hover:bg-muted/30">
                        ...
                        <td className="px-3 py-2 text-muted-foreground">
                          <CountryLink name={r.nationality} />
                        </td>
                        ...
                        <td className="px-3 py-2">
                          {(() => {
                            const off = clubMap
                              ? resolveClub(r.club, r.season_year, clubMap)
                              : null;
                        ...
                        <td className="px-3 py-2 tabular-nums">
                          {compFilter === "unified" ? "—" : r.season_year}
                        </td>
              ...
              <div className="flex items-center justify-between p-3 text-xs text-muted-foreground border-t border-border">
                <span>
                  {ranked.length} jogadores · página {page + 1}/{totalPages}
                </span>
...
export function CompetitionRankingsView({
  mode,
  withDecay,
}: {
  mode: "weighted" | "raw";
  ...
  const years = useMemo(
    () => [...new Set(comps.map((c) => c.season_year))].sort((a, b) => b - a),
    [comps],
  );
  const latestYear = years[0] ?? new Date().getFullYear();
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-2">
        {(["all", "superleague", "national", "continental", "international"] as const).map((v) => (
          <Button
            key={v}
            size="sm"
            variant={compFilter === v ? "secondary" : "outline"}
            onClick={() => {
              setCompFilter(v);
              setPage(0);
            }}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
          <div>
            ...
            <Input
              ...
              placeholder="competição/país/continente"
            />
          </div>
          <div>
            <Label className="text-xs">Época (de)</Label>
      ...
      <Card className="overflow-hidden">
              ...
              {pageRows.map((r, i) => (
                <tr key={r.key} className="border-t border-border/50 hover:bg-muted/30">
                  ...
                  <td className="px-3 py-2 text-right tabular-nums">
                    {r.reputation_clubs_avg == null ? "—" : fmtNum(r.reputation_clubs_avg, 2)}
                  </td>
                </tr>
              ))}
              {pageRows.length === 0 && (
        ...
        <div className="flex items-center justify-between p-3 text-xs text-muted-foreground border-t border-border">
          <span>
            {ranked.length} competições · página {page + 1}/{totalPages}
          </span>
          <div className="flex gap-2">
            <Button
              size="sm"
