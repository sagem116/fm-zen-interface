...
import { type SidebarPrefs, DEFAULT_PREFS, reorder, DEBUG_GROUP } from "@/lib/sidebar-prefs";
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span
                    className={cn(
                      ...
                      gPrefs.hidden && "opacity-50 line-through",
                    )}
                  >
                    {title}
                  </span>
          ...
          <div className="rounded-lg border border-border p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span
                className={cn(
                  "text-sm font-semibold flex-1",
                  draft.debugHidden && "opacity-50 line-through",
                )}
              >
                Debug
              </span>
