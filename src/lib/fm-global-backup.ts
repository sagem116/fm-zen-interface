...
const BUCKETS: Record<string, readonly string[]> = {
  weights: ["fm-sugestao-pesos-formulas", "fm-sugestao-pesos-active"],
  ui: ["fm-sidebar-prefs-v1", "fm-theme", "fm:rankings-ui-version"],
  desafios: ["fm-desafios-v2", "fm-highlights-v1"],
  geo: ["fm.country.continentOverrides.v1", "fm.country.aliasOverrides.v1"],
  reputation: ["fm-club-reputation-v1", "fm-club-name-aliases-v1", "fm-club-reputation-imports-v1"],
  clubMap: ["fm-club-name-aliases-v2", "fm-club-manual-map-v1"],
  custom: ["fm-custom-formulas-v1", "fm-custom-rankings-v1", "fm-saved-filters-v1"],
  insights: ["fm-insights-snapshots-v1"],
};
