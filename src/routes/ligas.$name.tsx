...
function LeagueProfilePage() {
  ...
  const moduleLabel =
    champions[0]?.module === "superleague"
      ? "Super League"
      : champions.length
        ? "Liga Nacional"
        : "Liga";
        ...
        <>
          <div className="flex items-center gap-3">
            ...
            <div className="flex rounded-lg border border-border p-1">
              <Button
                size="sm"
                variant={view === "club" ? "default" : "ghost"}
              ...
              <Button
                size="sm"
                variant={view === "coach" ? "default" : "ghost"}
                ...
                <thead>
                  <tr className="border-b border-border text-muted-foreground text-xs uppercase">
                    ...
                    <th className="text-left p-3">
                      <Crown className="size-3.5 inline mr-1" /> Campeão
                    </th>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Evolução do plantel da liga</CardTitle>
            </CardHeader>
            <CardContent>
              <PlayerAttrsChart players={data.data.players} filter={{ league: decoded }} />
            </CardContent>
          </Card>
        </>
      )}
