-- Ensure legacy/current player_profiles table exists (idempotent).
-- The original migration was not present on some remix databases,
-- causing "Could not find the table 'public.player_profiles'" errors.
