...
CREATE TABLE public.players (
  ...
  idu text, name text NOT NULL, league text,
  club_name text, club_id uuid,
  age integer,
...
-- GRANTS
GRANT SELECT, INSERT, UPDATE, DELETE ON public.seasons, public.imports, public.countries, public.clubs, public.coaches, public.standings, public.continental_results, public.coach_assignments, public.weight_profiles, public.config_weights, public.players, public.international_results TO anon, authenticated;
GRANT ALL ON public.seasons, public.imports, public.countries, public.clubs, public.coaches, public.standings, public.continental_results, public.coach_assignments, public.weight_profiles, public.config_weights, public.players, public.international_results TO service_role;
